...
- **Network Infrastructure Tests**: Achieved through the use and testing of network elements such as switches, routers, firewalls, and the resources supporting them, for example (AAA, IPS…).
...
- **Unknown-Environment Test:** The tester is given a small amount of information. Domain names and IP addresses within scope may be given to the attacker. The purpose of this black-box test is to allow the assessment to be made from the perspective of an outside attacker.
