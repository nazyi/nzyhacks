...
layout: post
lang: en
desc: "The first lesson of the JumpCloud University Core course: the Admin Console and User Portal interfaces, organization settings, admin roles/permissions, and recommended security/password policies."
