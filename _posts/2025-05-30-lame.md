...
categories: [makine]
layout: post
description: "Lame, kök (root) erişimi elde etmek için yalnızca tek bir istismar gerektiren kolay bir Linux makinesidir. Hack The Box platformunda yayımlanan ilk makineydi ve emekli edilmeden önce genellikle yeni kullanıcıların ilk denediği makineydi."
logo: "/assets/images/lame.png"
author: nazy
title: HTB Lame
tags: [HTB, vsftpd Backdoor]
order: 1
translation_url: /en/lame
---
...
<div style="text-align: center;">
  <img loading="lazy" src="{{ '/assets/images/htb_lame/porttarama.webp' | relative_url }}" width="740" height="420" alt="nmap -sV -sC taramasının vsftpd ve Samba servis versiyonları">
</div>
...
<div style="text-align: center;">
  <img loading="lazy" src="{{ '/assets/images/htb_lame/exploitmodul.webp' | relative_url }}" width="940" height="120" alt="searchsploit vsFTPd 2.3.4 sorgusunun bulduğu exploit modülleri">
</div>
...
<div style="text-align: center;">
  <img loading="lazy" src="{{ '/assets/images/htb_lame/showoptions.webp' | relative_url }}" width="1000" height="200" alt="Metasploit vsftpd_234_backdoor modülünün show options çıktısı">
</div>
...
<div style="text-align: center;">
  <img loading="lazy" src="{{ '/assets/images/htb_lame/sambamodul.webp' | relative_url }}" width="1000" height="170" alt="Metasploit'te Samba 3.0.20 için arama sonucu bulunan modüller">
</div>
...
<div style="text-align: center;">
  <img loading="lazy" src="{{ '/assets/images/htb_lame/sambashow.webp' | relative_url }}" width="1000" height="300" alt="Metasploit usermap_script modülünün show options çıktısı">
</div>
