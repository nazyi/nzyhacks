...
<div style="text-align: center;">
  <img loading="lazy" src="{{ '/assets/images/kimlik/tablo.png' | relative_url }}" width="700" height="260" alt="SAML ve OAuth kimlik doğrulama protokollerini karşılaştıran tablo">
</div>
